...
function renderNavHtml() {
  if (!flag) {
    ...
    <li><a class="nav-main__list__item all-posts" href="../layout/all-posts.html" title="Trip Blog || All Posts">All Posts</a></li>
    <li><a class="nav-main__list__item contact" href="../layout/contact.html" title="Trip Blog || Contact">Contact</a></li>
  `;

    const listItems = document.querySelectorAll(".nav-main__list__item");
    ...
    navMainList.classList.remove("nav-main__list__on");
    navMainList.innerHTML = "";
  }
}
...
function renderNavFullScreen() {
  navMainList.classList.add("nav-main__list__on");
  navMainList.innerHTML = `
    <li><a class="nav-main__list__item home" href="../index.html" title="Trip Blog || Home Page">Home</a></li>
    <li><a class="nav-main__list__item about" href="../layout/about.html" title="Trip Blog || About">About</a></li>
    <li><a class="nav-main__list__item all-posts" href="../layout/all-posts.html" title="Trip Blog || All Posts">All Posts</a></li>
